...
void up_01(){
    ...
    vertical_0.write(v_default + 50);           //up compelx 0 and 1
    vertical_1.write(v_default + 90 - 50);
...
void up_12(){
    ...
    vertical_1.write(v_default + 90 - 50);     //up complex 1 and 2
    vertical_2.write(v_default + 50);
...
void up_23(){
    ...
    vertical_2.write(v_default + 50);           //up complex 2 and 3
    vertical_3.write(v_default + 90 - 50);
...
void up_30(){
    ...
    vertical_0.write(v_default + 50);         //up complex 3 and 0   
    vertical_3.write(v_default + 90 - 50);
